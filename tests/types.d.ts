...
export type paths = {
    ...
    "/read-only-property-body": {
        ...
        get?: never;
        put?: never;
        post: operations["readOnlyPropertyBody"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/write-only-property-body": {
        ...
        get?: never;
        put?: never;
        post: operations["writeOnlyPropertyBody"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
            ...
            201: {
                ...
                content: {
                    "application/json": {
                        /** @example Hello, World! */
                        message?: string;
                        /** @example This is a write-only property */
                        writeOnlyProperty?: string;
                    };
                };
            };
